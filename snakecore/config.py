...
class _FieldContainer:
    ...
    def __init__(
        self, var: Any, read_only: bool = False, write_once: bool = False
    ) -> None:
        self.var = var
...
class SupportsField(Protocol):
    ...
    should inherit `ConfigurationBase`.
    """
...
class BaseField(Generic[_T], ABC):
    ...
    def __init__(self, init_val: _T) -> None:
        """Initialise a Field object with an initial value.

        Parameters
        ----------
        init_val : type
            The initial field value type.
        """
...
class Field(BaseField[_T]):
    ...
    @overload
    def __init__(self, *, init_val: _T, var_type: type[_T] = _UnsetType) -> None:
        ...
        ------
        ValueError
            Invalid values for the specified arguments.
        TypeError
            Invalid types for the specified arguments.
        """

    # passing constructor, cannot pass init val. var_type is mandatory here
    @overload
    def __init__(self, *, init_constr: Callable[[], _T], var_type: type[_T]) -> None:
        """""Initialise a Field object with an initial constructor and type.

        Parameters
        ----------
        init_constr : Callable[[], T]
            The constructor used to make a default value.
            Passing a constructor is useful while dealing with mutable types.
        var_type : type[T], optional
            The explicit type(s) to enforce on assigment to the field.
            This primarily exists to allow wider types than the default value
            If this argument is not passed, it infers type from the default
    ...
    # default
    @overload
    def __init__(self, *, var_type: type[_T], write_once: bool = False) -> None:
        """Initialise a Field object with a type. In this case, the field remains
        in an unset state till the first assignment.

        Parameters
        ----------
        var_type : type[T]
            The explicit type(s) to enforce on assigmentto the field.
        write_once : bool, optional
            Whether repeated assignments to the field should be disallowed,
            by raising an `AttributeError`. Defaults to False.
    ...
    def validate(self, obj: _T):
        """A helper method for `__set__` to inspect an object before setting it.
...
class ConfigurationBase(SupportsField):
    ...
    def is_write_once(self, name: str) -> bool:
